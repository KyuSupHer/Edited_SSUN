...
def HyperspectralSamples(dataID=1, timestep=4, w=24, num_PC=3, israndom=False, s1s2=2):   
    ...
    if dataID==1:
        data = sio.loadmat('/Users/Michele/Desktop/trans/SSUN-master/SSUN_Data/PaviaU.mat')
        X = data['paviaU']
    
        data = sio.loadmat('/Users/Michele/Desktop/trans/SSUN-master/SSUN_Data/PaviaU_gt.mat')
        Y = data['paviaU_gt']
